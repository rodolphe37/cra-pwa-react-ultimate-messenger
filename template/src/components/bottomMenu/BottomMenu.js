        ...
        <ul className=" inner-content-nav flex lg:block font-obviously-narrow font-medium lowercase text-11 lg:text-10 leading-tight">
          ...
          <li className="flex-1 lg:my-4 text-center ">
            <a
              ...
              target="new"
              className="nav-bar__link block p-2 text-gray-500 hover:text-black"
            >
              <svg
                data-id="icon-bottle"
                ...
                viewBox="0 0 28 28"
              >
                <g fill="currentColor" className="svg-sos-bottle">
          ...
          <li className="flex-1 lg:my-4 text-center ">
            <a
              ...
              target="new"
              className="nav-bar__link block p-2 text-gray-500 hover:text-black nav-bar-publish__link"
            >
          ...
          <li className="flex-1 lg:my-4 text-center ">
            ...
            >
              <svg
                ...
                viewBox="0 0 28 28"
              >
                <g fill="currentColor" className="svg-dices__sparkles">
          ...
          <li className="flex-1 lg:my-4 text-center relative">
            <a
              href="https://github.com/rodolphe37/rum-open-sources"
              className="nav-bar__link block p-2 text-gray-500 hover:text-black"
            >
              <svg
                data-id="icon-user"
