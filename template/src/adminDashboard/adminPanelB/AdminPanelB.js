      ...
      {isAdmin && (
        <div className="html">
          <div className="admin-container">
            ...
            <header
              className={
                collapseMenu ? "page-header page-header-hidden" : "page-header"
              }
            >
              <nav className={expandMenu ? " mob-menu-opened" : ""}>
                <button
                ...
                <ul
                  className={
                    expandMenu ? "admin-menu admin-menu-visible" : "admin-menu"
                  }
                >
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span>Dashboard alternative</span>
                    </a>
                  </li>
                  <li>
                    <a href="#0">
                  ...
                  <li>
                    <div className="switch">
                      ...
                      <label htmlFor="mode">
                        <span></span>
                        <span>{`${selectedDarkTheme ? "Dark" : "Light"}`}</span>
                      </label>
                    </div>
                    <button
